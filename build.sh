...
riscv64-unknown-elf-gcc -nostdlib -fno-builtin -march=rv64gc -mabi=lp64f -g -Wall -ffreestanding -mcmodel=medany -I ./src/drivers -T linker.ld -o bl33.elf "${SOURCE_FILES[@]}"
