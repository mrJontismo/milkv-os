...
SOURCE_FILES=("src/kernel/start.S" "src/kernel/main.c" "src/drivers/uart.c" "src/kernel/pma.c" "src/libs/string.c")

riscv64-unknown-elf-gcc -nostdlib -fno-builtin -march=rv64gc -mabi=lp64f -g -Wall -ffreestanding -mcmodel=medany -I ./include -T linker.ld -o bl33.elf "${SOURCE_FILES[@]}"
