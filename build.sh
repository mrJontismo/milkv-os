...
riscv64-unknown-elf-gcc -nostdlib -fno-builtin -march=rv64gc -mabi=lp64f -g -Wall -ffreestanding -mcmodel=medany -I ./include -T kernel.ld -o bl33.elf "${SOURCE_FILES[@]}"
